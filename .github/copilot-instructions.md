...
- `curl https://...` — response body floods context. For external docs or HTML, use `ctx_fetch_and_index` → `ctx_search`; for API calls you need to analyze in the sandbox, use `ctx_execute` and print a summary instead of raw output.
